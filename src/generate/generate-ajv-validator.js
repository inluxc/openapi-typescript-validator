...
exports.generateAjvValidator = void 0;
var node_fs_1 = require("node:fs");
var node_path_1 = __importDefault(require("node:path"));
var prettier = __importStar(require("prettier"));
function generateAjvValidator(prettierOptions, outDirs) {
    return __awaiter(this, void 0, void 0, function () {
        var helpers, _i, outDirs_1, outDir;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prettier.format(helpersTemplate, prettierOptions)];
                case 1:
                    helpers = _a.sent();
                    for (_i = 0, outDirs_1 = outDirs; _i < outDirs_1.length; _i++) {
                        outDir = outDirs_1[_i];
                        (0, node_fs_1.mkdirSync)(outDir, { recursive: true });
                        (0, node_fs_1.writeFileSync)(node_path_1.default.join(outDir, "validate.ts"), helpers);
                    }
                    return [2 /*return*/];
            }
        });
...
exports.generateAjvValidator = generateAjvValidator;
...
//# sourceMappingURL=generate-ajv-validator.js.map