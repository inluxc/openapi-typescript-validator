...
exports.generateCompileBasedDecoders = void 0;
var node_fs_1 = require("node:fs");
var node_path_1 = __importDefault(require("node:path"));
var prettier = __importStar(require("prettier"));
var generation_utils_1 = require("./generation-utils");
function generateCompileBasedDecoders(definitionNames, addFormats, formatOptions, outDirs, prettierOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var decoders, rawDecoderOutput, decoderOutput, _i, outDirs_1, outDir;
            ...
            switch (_a.label) {
                case 0:
                    decoders = definitionNames
                        ...
                        .join("\n");
                    rawDecoderOutput = decodersFileTemplate
                        .replace(/\$Imports/g, addFormats ? 'import addFormats from "ajv-formats"' : "")
                        .replace(/\$Formats/g, addFormats
                        ? "addFormats(ajv, ".concat(formatOptions ? JSON.stringify(formatOptions) : "undefined", ");")
                        : "")
                ...
                case 1:
                    ...
                    for (_i = 0, outDirs_1 = outDirs; _i < outDirs_1.length; _i++) {
                        ...
                        (0, node_fs_1.writeFileSync)(node_path_1.default.join(outDir, "decoders.ts"), decoderOutput);
                    }
                    return [2 /*return*/];
            }
        });
...
exports.generateCompileBasedDecoders = generateCompileBasedDecoders;
...
//# sourceMappingURL=generate-compile-decoders.js.map